...
* Memory: at least 4G
* NVIDIA 50-series (Blackwell) GPUs require **v1.1** or later
...
* Upgrade PyTorch to 2.7.1+cu128, add NVIDIA 50-series (Blackwell) GPU support
* Upgrade Python to 3.12, librosa to 0.9.2
* Update FFmpeg and 7-Zip bundled components
* Add GitHub Actions CI build pipeline for Windows
